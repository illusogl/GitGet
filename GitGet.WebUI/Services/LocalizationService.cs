...
public class LocalizationService
{
    ...
    private static readonly Dictionary<string, string> _zh = new()
    {
        ...
        ["login.token_hint"] = "输入你的 GitHub Personal Access Token。在",
        ["login.token_link"] = "这里创建",
        ["login.token_submit"] = "登录",
        ["login.invalid_token"] = "Token 无效，请检查后重试",
        ["login.or"] = "—— 或 ——",
        ["login.device_flow"] = "通过浏览器验证登录",
        ["login.connecting"] = "正在连接...",
        ["login.step1"] = "1. 点击下方按钮打开 GitHub 页面",
        ["login.step2"] = "2. 输入验证码完成授权",
        ["login.copy"] = "复制",
        ["login.copied"] = "已复制",
        ["login.open_github"] = "打开 GitHub 授权页",
        ["login.checking"] = "检查授权",
        ["login.done_auth"] = "已完成授权，检查登录",
        ["login.please_retry"] = "网络错误，请稍后重试",
        ["login.still_pending"] = "尚未完成授权，请先在浏览器中输入验证码",
        ["login.open_browser"] = "在浏览器中打开以下页面并输入验证码：",
        ["login.enter_code_at"] = "在 ",
        ["login.open_in_browser"] = "在浏览器中打开",
        ["login.waiting_auth"] = "等待授权",
        ["login.cancel"] = "取消",
        ["login.retry"] = "重试",
        ["login.error"] = "登录失败",
        ["login.expired"] = "验证码已过期，请重新开始",
        ["login.denied"] = "授权被拒绝",
        ["login.unknown_error"] = "未知错误",
        ["login.poll_error"] = "轮询错误",
        ["login.timeout"] = "超时",
        ["login.logged_in"] = "已登录",
        ["login.logged_in_desc"] = "你已成功登录 GitHub",
        ["login.logout"] = "退出登录",
    ...
    private static readonly Dictionary<string, string> _en = new()
    {
        ...
        ["login.token_method"] = "Use Personal Access Token",
        ["login.token_hint"] = "Enter your GitHub Personal Access Token. Create one at",
        ["login.token_link"] = "here",
        ["login.token_submit"] = "Login",
        ["login.invalid_token"] = "Invalid token. Please check and try again",
        ["login.or"] = "—— or ——",
        ["login.device_flow"] = "Login via Browser Verification",
        ["login.connecting"] = "Connecting...",
        ["login.step1"] = "1. Click the button below to open GitHub",
        ["login.step2"] = "2. Enter the verification code to authorize",
        ["login.copy"] = "Copy",
        ["login.copied"] = "Copied",
        ["login.open_github"] = "Open GitHub Authorization",
        ["login.checking"] = "Checking",
        ["login.done_auth"] = "I've authorized, check now",
        ["login.please_retry"] = "Network error, please try again later",
        ["login.still_pending"] = "Authorization not yet complete. Please enter the code in your browser first",
        ["login.open_browser"] = "Open the following page in your browser and enter the code:",
        ["login.enter_code_at"] = "at ",
        ["login.open_in_browser"] = "Open in Browser",
        ["login.waiting_auth"] = "Waiting for authorization",
        ["login.cancel"] = "Cancel",
        ["login.retry"] = "Retry",
        ["login.error"] = "Login failed",
        ["login.expired"] = "Code expired. Please start over",
        ["login.denied"] = "Authorization denied",
        ["login.unknown_error"] = "Unknown error",
        ["login.poll_error"] = "Polling error",
        ["login.timeout"] = "Timeout",
        ["login.logged_in"] = "Logged In",
        ["login.logged_in_desc"] = "You are logged in to GitHub",
        ["login.logout"] = "Logout",
